...
const { expr } = jexl
const doYouWant = expr`"Do you want  " + thing + "? Because that's how you get " + thing+"!"` // Or without expr: jexl.compile('"Do you want " + place + "?"')
doYouWant.evalSync({ place: 'ants' }) // Do you want ants? Because that's how you get ants!
doYouWant.evalSync({ place: 'ANTS!!!' }) // Do you want ANTS!!!? Because that's how you you get ANTS!!! (Doesn't recompile the expression!)
```
